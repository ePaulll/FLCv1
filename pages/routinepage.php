...
?>
                        ...
                        <li class="list-group-item">
                            ...
                            <button class="btn btn-primary btn-edit" data-toggle="modal"
                                data-target="#editModal-<?php echo $exercise_row['exercise_id']; ?>">Edit</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel-<?php echo $exercise_id; ?>">Edit Exercise</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sets-<?php echo $exercise_id; ?>"
                                        value="<?php echo $exercise_sets; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="weight-<?php echo $exercise_id; ?>">Weight</label>
                                    <input type="text" class="form-control" id="weight-<?php echo $exercise_id; ?>"
