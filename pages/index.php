        ...
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            ...
            <form action="../db/functions.php" method="POST">
              ...
              <input type="email" class="form-control" id="usermail" name="usrEmail" placeholder="Enter Email">
              ...
              <div class="d-grid">
              <button type="submit" id="loginbutton" class="btn btn-primary btn-login text-uppercase fw-bold" name="loginusr">Sign in</button>
              </div>
              <hr class="my-4">
            </form>
